...
ifeq ($(UNAME), Windows)
  ...
  LIBRARIES := -Lexternal/library/ftxui/windows -Lexternal/library/sdl/windows -Lexternal/library/taglib/windows -static -Wl,-Bstatic -lgcc -lstdc++ -lssp -lwinpthread -Wl,-Bdynamic -lftxui-component -lftxui-dom -lftxui-screen -lSDL2 -lSDL2_mixer -ltag
