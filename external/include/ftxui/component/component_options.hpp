...
#include <dom/direction.hpp>  // for Direction, Direction::Left, Direction::Right, Direction::Down
#include <dom/elements.hpp>  // for Element, separator
#include <util/ref.hpp>      // for Ref, ConstRef, StringRef
#include <functional>              // for function
#include <string>                  // for string

#include "component/component_base.hpp"  // for Component
